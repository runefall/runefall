  ...
  return (
    <div className="m-8 mx-auto max-w-screen-xl px-4">
      <section 
        ...
        <h2 className="text-3xl font-bold">Powerful Legends of Runeterra Card Search</h2>
      </section>

      <section 
        data-test-id="about-runefall"
        className="mb-8 gap-4 ">
      ...
      <section 
        data-test-id="about-why"
        className="mb-8 gap-4 ">
        <h2 className="text-3xl font-bold">Why did we make Runefall?</h2>
        <p>
            Runefall was designed primarily designed as a project for graduation by students attending Turing School of Software and Design.
            It was created to demonstrate our knowledge and skills while also allowing us to explore new technologies. 
            Functionally, it was designed to fill in the gap of missing features or out-of-date information from other, similar card search applications for Legends of Runeterra.
        </p>
      </section>

      <section 
        data-test-id="about-tech"
        className="mb-8 gap-4 ">
        <h2 className="text-3xl font-bold">The tech behind the magic</h2>
        <p>
            Runefall was built using TypeScript and React components. 
            Our backend was built with Ruby, Ruby on Rails and PostgreSQL.
            We used Netlify and Heroku for hosting.
            Card images are hosted and provided by Riot Games. 
        </p>
      </section>
